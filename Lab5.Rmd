...
```
The hypothesis is not supported, since the difference between the GPA of Greek women and non-Greek women is not significant (p = .38).
...
```
The hypothesis is not supported, since the difference between the GPA of men and women is generally not significant (p = .73).
